...
```
Cart and Random Forest are the closest to the original distribution so we use for example RF to take the same method as for the individual variables
...
Individual level: qc6_10, qc6_11, qc15_1, qc15_2, qc18_1, qc17_4, qc17_5

Aggregate level: eu_unemployment_female, eu_unemployment_male, no_compulsory_ medical_intervention_required  , social_globalisation, religious_importance, fundamental_rights, gdp_per_capita, quality_of_democracy, conversion_practices_ban, No_Gender_Identity_Disorder_diagnosis_psychological_opinion_required
